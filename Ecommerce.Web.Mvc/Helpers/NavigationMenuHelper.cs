...
public class NavigationMenuHelper
{
    public List<NavMenu> NavMenuBuilder()
    {
        ...
        navmenu.Add(new NavMenu { Id = 1, ParentMenuId = null, Name = "Categories", Key = Permissions.Permissions_Category_View, ControllerName = "Categories", ActionName = "Index", IsActive = true, IsVisible = true, MenuIcon = "fas fa-code-branch" });
        navmenu.Add(new NavMenu { Id = 2, ParentMenuId = null, Name = "Color", Key = Permissions.Permissions_Color_View, ControllerName = "Color", ActionName = "Index", IsActive = true, IsVisible = true, MenuIcon = "fas fa-palette" });
        navmenu.Add(new NavMenu { Id = 3, ParentMenuId = null, Name = "Size", Key = Permissions.Permissions_Size_View, ControllerName = "Size", ActionName = "Index", IsActive = true, IsVisible = true, MenuIcon = "fas fa-weight-hanging" });
        navmenu.Add(new NavMenu { Id = 4, ParentMenuId = null, Name = "Products", Key = Permissions.Permissions_Product_View, ControllerName = "Product", ActionName = "Index", IsActive = true, IsVisible = true, MenuIcon = "fas fa-box" });
        ...
        navmenu.Add(new NavMenu { Id = 9, ParentMenuId = null, Name = "Order Status", Key = Permissions.Permissions_OrderStatus_View, ControllerName = "OrderStatusValue", ActionName = "Index", IsActive = true, IsVisible = true, MenuIcon = "fas fa-shopping-bag" });
        navmenu.Add(new NavMenu { Id = 10, ParentMenuId = null, Name = "Delivery Method", Key = Permissions.Permissions_DeliveryMethod_View, ControllerName = "DeliveryMethod", ActionName = "Index", IsActive = true, IsVisible = true, MenuIcon = "fas fa-truck" });
        navmenu.Add(new NavMenu { Id = 11, ParentMenuId = null, Name = "Customer", Key = Permissions.Permissions_Customer_View, ControllerName = "Customer", ActionName = "Index", IsActive = true, IsVisible = true, MenuIcon = "fas fa-users" });
        navmenu.Add(new NavMenu { Id = 12, ParentMenuId = null, Name = "Customer Review", Key = Permissions.Permissions_ProductReview_View, ControllerName = "CustomerReview", ActionName = "Index", IsActive = true, IsVisible = true, MenuIcon = "fas fa-star-half-alt" });
        navmenu.Add(new NavMenu { Id = 13, ParentMenuId = null, Name = "Orders", Key = Permissions.Permissions_Order_View, ControllerName = "Order", ActionName = "Index", IsActive = true, IsVisible = true, MenuIcon = "fas fa-shopping-cart" });
        ...
        //navmenu.Add(new NavMenu { Id = 31, ParentMenuId = 14, Name = "Completed Orders", Key = Permissions.Permissions_Order_View, ControllerName = "Order", ActionName = "Completed", IsActive = true, IsVisible = true });
        ...
        navmenu.Add(new NavMenu { Id = 33, ParentMenuId = null, Name = "Sailes", Key = Permissions.Permissions_Sailes_View, ControllerName = "Sailes", ActionName = "Index", IsActive = true, IsVisible = true, MenuIcon = "fas fa-code-branch" });
