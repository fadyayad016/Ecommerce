...
namespace Ecommerce.Infrastructure.Sql.Migrations
{
    ...
    [Migration("20250220202605_TblBoxesCurrencies")]
    partial class TblBoxesCurrencies
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Ecommerce.Domain.Entities.Barcode", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Ecommerce.Domain.Entities.Boxes", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<string>("Name")
                        ...
                        .HasColumnName("Name")
                        .HasComment("The name of the Box");
            ...
            modelBuilder.Entity("Ecommerce.Domain.Entities.BoxesCurrencies", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Ecommerce.Domain.Entities.Color", b =>
                {
                    ...
                    SqlServerIndexBuilderExtensions.IsClustered(b.HasIndex("HexCode"), false);
            ...
            modelBuilder.Entity("Ecommerce.Domain.Entities.Currency", b =>
                {
                    ...
                    b.Property<string>("Name")
                        ...
                        .HasColumnType("nvarchar(30)")
                        .HasColumnName("Name")
                        .HasComment("The name of the Currency");
            ...
            modelBuilder.Entity("Ecommerce.Domain.Entities.Product", b =>
                {
                    ...
                    b.Property<bool>("IsActive")
                        .HasColumnType("bit")
                        .HasColumnName("IsActive")
                        .HasComment("The Status of the product (active/inactive)");

                    b.Property<bool>("IsSerial")
                        .HasColumnType("bit")
                        .HasColumnName("IsSerial")
                        .HasComment("The product Is Serial (Yes/No)");
            ...
            modelBuilder.Entity("Ecommerce.Domain.Entities.BoxesCurrencies", b =>
                {
                    b.HasOne("Ecommerce.Domain.Entities.Boxes", "Boxes")
                        .WithMany("BoxesCurrencies")
                        .HasForeignKey("BoxId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Ecommerce.Domain.Entities.Currency", "Currencies")
                        .WithMany()
            ...
            modelBuilder.Entity("Ecommerce.Domain.Entities.Store", b =>
                {
                    b.HasOne("Ecommerce.Domain.Entities.City", "Cities")
                        .WithMany()
